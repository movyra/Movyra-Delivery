...
export default function DeliveryApp() {
  ...
  const renderHome = () => (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pb-24">
      ...
      <div className="bg-[#00A9F7] px-4 pt-4 pb-12 rounded-b-[40px] shadow-sm relative z-40">
        ...
        <div className="bg-[#FFFFFF] rounded-2xl p-4 flex flex-col gap-3 shadow-lg absolute -bottom-16 left-4 right-4 cursor-pointer hover:shadow-xl transition-shadow border border-[#E5E7EB]">
          <div className="flex items-center gap-3 border-b border-[#F2F4F7] pb-3">
            ...
            <div className="flex flex-col flex-1">
              <span className="text-[#111111] font-black text-[0.95rem] leading-tight">Pick up from</span>
              <span className="text-[#111111]/60 text-[0.8rem] font-bold truncate max-w-[220px]">{activePickup}</span>
            </div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-[#F2F4F7] flex items-center justify-center text-[#ff4444]">
            ...
            <div className="flex flex-col flex-1">
              <span className="text-[#111111] font-black text-[0.95rem] leading-tight">Deliver to</span>
              <span className="text-[#111111]/60 text-[0.8rem] font-bold truncate max-w-[220px]">{activeDropoff}</span>
            </div>
            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#111111" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
          </div>
        </div>
      ...
      <div className="px-4 mt-24">
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            { id: 'Trucks', icon: <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="#111111" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg> },
            ...
            { id: 'Packers & Movers', icon: <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="#111111" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg> }
          ].map((vehicle) => (
            <button key={vehicle.id} onClick={() => setSelectedVehicle(vehicle.id)} className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-[24px] p-4 flex flex-col items-center justify-center gap-3 shadow-sm hover:border-[#00A9F7] hover:shadow-md transition-all h-[120px]">
              {vehicle.icon}
        ...
        <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-[24px] p-5 flex items-center justify-between shadow-sm mb-8">
        ...
        <div className="w-full bg-[#00A9F7] rounded-[24px] p-6 text-[#FFFFFF] shadow-lg mb-8 relative overflow-hidden flex flex-col items-center text-center">
          ...
          <div className="w-full bg-[#FFFFFF]/10 backdrop-blur-sm rounded-xl p-4 mb-6 border border-[#FFFFFF]/20">
             <span className="font-black text-[1.2rem]">Send up to 3000 kg</span>
          </div>

          <div className="w-full flex flex-col gap-3 mb-6">
            {['Mumbai', 'Ahmadnagar', 'Surat'].map(city => (
              <div key={city} className="bg-[#FFFFFF] text-[#111111] rounded-xl p-4 flex items-center gap-4 shadow-sm text-left border border-[#E5E7EB]">
                <div className="w-10 h-10 bg-[#F2F4F7] rounded-full flex items-center justify-center text-[#111111]">
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                </div>
                <div className="flex flex-col">
          ...
          <button onClick={() => setSelectedVehicle('PartLoad Heavy')} className="w-full bg-[#FFFFFF] text-[#00A9F7] py-4 rounded-xl font-black text-[1.1rem] hover:bg-[#F2F4F7] transition-colors shadow-md">
            Book Now
          </button>
        </div>
            ...
            <motion.div initial={{ y: 200 }} animate={{ y: 0 }} exit={{ y: 200 }} className="w-full max-w-[600px] bg-[#FFFFFF] rounded-t-3xl p-6 flex flex-col">
              ...
              <div className="flex flex-col gap-4 mb-8">
                <div className="bg-[#F2F4F7] p-3 rounded-xl">
                  <span className="block text-[0.7rem] font-bold text-[#111111]/60 uppercase mb-1">Pickup</span>
                  <span className="font-bold text-[#111111] text-[0.9rem] truncate block">{activePickup}</span>
                </div>
                <div className="bg-[#F2F4F7] p-3 rounded-xl">
                  <span className="block text-[0.7rem] font-bold text-[#111111]/60 uppercase mb-1">Drop-off</span>
                  <span className="font-bold text-[#111111] text-[0.9rem] truncate block">{activeDropoff}</span>
                </div>
              </div>
  ...
  const renderOrders = () => (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full min-h-screen bg-[#F2F4F7] pb-24">
      <div className="bg-[#FFFFFF] px-6 pt-10 pb-4 sticky top-0 z-40 shadow-sm border-b border-[#E5E7EB]">
      ...
      <div className="p-4">
        ...
        {orders.length === 0 ? (
          <div className="bg-[#FFFFFF] rounded-[24px] p-8 flex flex-col items-center text-center shadow-sm border border-[#E5E7EB]">
          ...
          <div className="flex flex-col gap-4">
            {orders.map((order) => (
              <div key={order.id} className="bg-[#FFFFFF] rounded-[24px] shadow-sm border border-[#E5E7EB] overflow-hidden">
                ...
                <div className="px-5 pb-5 pt-2 flex items-center justify-between border-t border-[#E5E7EB] mt-2">
                  ...
                  <button onClick={() => setSelectedVehicle(order.vehicleType)} className="bg-[#00A9F7] text-[#FFFFFF] px-6 py-2.5 rounded-xl font-black text-[0.9rem] hover:bg-[#0091D5] transition-colors mt-3">Book Again</button>
                </div>
              </div>
            ))}
          </div>
  ...
  const renderCoins = () => (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full min-h-screen bg-[#FFFFFF] pb-24">
      ...
      <div className="p-4 pt-10">
        {/* Main Balance Banner */}
        <div className="w-full bg-[#111111] rounded-[24px] p-6 shadow-md mb-8 relative overflow-hidden h-[160px] flex flex-col justify-center">
        ...
        <div className="grid grid-cols-2 gap-4 mb-10">
          <div className="bg-[#FFFFFF] rounded-2xl p-5 border border-[#E5E7EB] shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col cursor-pointer hover:border-[#00A9F7] transition-colors">
            <div className="mb-8">
               <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="#00A9F7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2" ry="2" fill="#E0E7FF"></rect><line x1="2" y1="10" x2="22" y2="10" stroke="#00A9F7"></line></svg>
            </div>
            <span className="text-[#00A9F7] font-bold text-[0.8rem] mb-1">Transfer into</span>
            <div className="flex items-center justify-between">
              <span className="text-[#00A9F7] font-black text-[1rem]">Movyra Credits</span>
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#00A9F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
            </div>
          </div>

          <div className="bg-[#FFFFFF] rounded-2xl p-5 border border-[#E5E7EB] shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col cursor-pointer hover:border-[#00A9F7] transition-colors relative overflow-hidden">
            <span className="absolute top-0 left-0 bg-[#00ff88] text-[#111111] font-black text-[0.6rem] uppercase tracking-widest px-2 py-1 rounded-br-xl">NEW 🎉</span>
            <div className="mb-8 mt-2">
              <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="#111111" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" fill="#F2F4F7"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4" stroke="#111111"></path></svg>
            </div>
            <span className="text-[#00A9F7] font-bold text-[0.8rem] mb-1">Transfer into</span>
            <div className="flex items-center justify-between">
              <span className="text-[#00A9F7] font-black text-[1rem]">Bank Account</span>
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#00A9F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-10">
           <div className="bg-[#F8FAFC] rounded-[24px] p-5 flex flex-col border border-[#E5E7EB]">
              ...
              <span className="text-[#00A9F7] font-black text-[0.95rem] flex items-center gap-1">Learn <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></span>
           </div>
           <div className="bg-[#F8FAFC] rounded-[24px] p-5 flex flex-col border border-[#E5E7EB]">
              <div className="mb-6 flex justify-center">
      ...
      <div className="p-4">
        <div className="bg-[#FFFFFF] rounded-[24px] p-6 shadow-sm border border-[#E5E7EB]">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="w-10 h-10 text-[#00A9F7]">
      ...
      <div className="p-4">
        ...
        <div className="bg-[#FFFFFF] rounded-[24px] p-6 shadow-sm border border-[#E5E7EB] mb-4">
          ...
          <div className="flex flex-col gap-2 mb-4">
             <span className="text-[#111111] font-black text-[1.1rem]">{profile.name || user?.email?.split('@')[0] || 'Authorized User'}</span>
             <span className="text-[#111111] font-bold text-[0.95rem]">{user?.email || 'admin@movyra.in'}</span>
          </div>

          <div className="bg-[#F2F4F7] inline-block px-3 py-1.5 rounded-lg border border-[#E5E7EB]">
             <span className="text-[#111111] font-black text-[0.95rem]">{profile.phone || '+91 - Authorized'}</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 mt-6">
           ...
           <div className="bg-[#FFFFFF] rounded-[24px] p-5 shadow-sm border border-[#E5E7EB] flex flex-col gap-2">
             ...
             <div className="flex items-center justify-between cursor-pointer py-2">
               ...
               <div className="flex items-center gap-3">
                 <span className="border border-[#00A9F7] text-[#00A9F7] px-4 py-1.5 rounded-xl font-bold text-[0.9rem] flex items-center gap-1"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Add GSTIN</span>
                 <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#111111" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
               </div>
             </div>
           </div>
           ...
           <div className="bg-[#FFFFFF] rounded-[24px] p-5 shadow-sm border border-[#E5E7EB] flex flex-col gap-2">
             ...
             <div className="flex items-center justify-between cursor-pointer py-2">
               ...
               <div className="flex items-center gap-3">
                 <span className="border border-[#00A9F7] text-[#00A9F7] px-4 py-1.5 rounded-xl font-bold text-[0.9rem] flex items-center gap-1"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg> Invite</span>
                 <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#111111" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
               </div>
             </div>
           </div>

           <div className="bg-[#FFFFFF] rounded-[24px] p-5 shadow-sm border border-[#E5E7EB] flex items-center justify-between cursor-pointer">
              <div className="flex items-center gap-4">
                 <div className="text-[#111111]"><svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg></div>
                 <div className="flex flex-col">
  ...
  return (
    <div className="w-full min-h-screen bg-[#F2F4F7] font-sans selection:bg-[#00A9F7] selection:text-[#FFFFFF] overflow-x-hidden">
      ...
      <div className="fixed bottom-0 left-0 w-full bg-[#FFFFFF] border-t border-[#E5E7EB] px-6 py-3 flex justify-between items-center z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        {[
          { id: 'Home', icon: <svg viewBox="0 0 24 24" width="24" height="24" fill={activeTab === 'Home' ? '#00A9F7' : 'none'} stroke={activeTab === 'Home' ? '#00A9F7' : '#666666'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> },
          { id: 'Orders', icon: <svg viewBox="0 0 24 24" width="24" height="24" fill={activeTab === 'Orders' ? '#00A9F7' : 'none'} stroke={activeTab === 'Orders' ? '#00A9F7' : '#666666'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> },
          { id: 'Coins', icon: <svg viewBox="0 0 24 24" width="24" height="24" fill={activeTab === 'Coins' ? '#00A9F7' : 'none'} stroke={activeTab === 'Coins' ? '#00A9F7' : '#666666'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 6v6l4 2"></path></svg> },
          { id: 'Payments', icon: <svg viewBox="0 0 24 24" width="24" height="24" fill={activeTab === 'Payments' ? '#00A9F7' : 'none'} stroke={activeTab === 'Payments' ? '#00A9F7' : '#666666'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2" ry="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line></svg> },
          { id: 'Account', icon: <svg viewBox="0 0 24 24" width="24" height="24" fill={activeTab === 'Account' ? '#00A9F7' : 'none'} stroke={activeTab === 'Account' ? '#00A9F7' : '#666666'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> }
        ].map((tab) => (
          <button 
            key={tab.id} 
            onClick={() => setActiveTab(tab.id)} 
            className={`flex flex-col items-center gap-1.5 transition-colors ${activeTab === tab.id ? 'text-[#00A9F7]' : 'text-[#111111]/70 hover:text-[#111111]'}`}
          >
            {tab.icon}
