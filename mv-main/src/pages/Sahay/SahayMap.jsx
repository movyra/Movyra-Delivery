...
export default function SahayMap() {
    ...
    const t = {
        en: {
            lang: "English", log_out: "Log out", careers: "Careers", sign_in: "Sign In", back: "Back to Home", sitemap: "Sitemap", sitemap_desc: "Direct navigation to all Sahay modules.",
        ...
        hi: {
            lang: "हिन्दी", log_out: "लॉग आउट", careers: "करियर", sign_in: "साइन इन", back: "होम पर वापस जाएं", sitemap: "प्लेटफ़ॉर्म साइटमैप", sitemap_desc: "सभी सहाय मॉड्यूल पर सीधा नेविगेशन।",
        ...
        hinglish: {
            lang: "Hinglish", log_out: "Log out", careers: "Careers", sign_in: "Sign In", back: "Home par wapas", sitemap: "Sitemap", sitemap_desc: "Sabhi Sahay modules ka direct navigation.",
        ...
        mr: {
            lang: "मराठी", log_out: "लॉग आउट", careers: "करिअर", sign_in: "साइन इन", back: "होम वर परत जा", sitemap: "प्लॅटफॉर्म साइटमॅप", sitemap_desc: "सर्व सहाय मॉड्यूल्ससाठी थेट नेव्हिगेशन.",
        ...
        gu: {
            lang: "ગુજરાતી", log_out: "લૉગ આઉટ", careers: "કારકિર્દી", sign_in: "સાઇન ઇન", back: "હોમ પર પાછા જાઓ", sitemap: "પ્લેટફોર્મ સાઇટમેપ", sitemap_desc: "તમામ સહાય મોડ્યુલો માટે સીધું નેવિગેશન.",
        ...
        te: {
            lang: "తెలుగు", log_out: "లాగౌట్", careers: "కెరీర్స్", sign_in: "సైన్ ఇన్", back: "హోమ్ కి తిరిగి వెళ్ళండి", sitemap: "ప్లాట్‌ఫారమ్ సైట్‌మ్యాప్", sitemap_desc: "అన్ని సహాయ్ మాడ్యూల్స్‌కు ప్రత్యక్ష నావిగేషన్.",
        ...
        ta: {
            lang: "தமிழ்", log_out: "வெளியேறு", careers: "தொழில்கள்", sign_in: "உள்நுழைய", back: "முகப்பிற்கு திரும்புக", sitemap: "தளத்தின் வரைபடம்", sitemap_desc: "அனைத்து சஹாய் தொகுதிகளுக்கும் நேரடி வழிசெலுத்தல்.",
        ...
        pa: {
            lang: "ਪੰਜਾਬੀ", log_out: "ਲੌਗ ਆਉਟ", careers: "ਕਰੀਅਰ", sign_in: "ਸਾਈਨ ਇਨ", back: "ਹੋਮ 'ਤੇ ਵਾਪਸ ਜਾਓ", sitemap: "ਪਲੇਟਫਾਰਮ ਸਾਈਟਮੈਪ", sitemap_desc: "ਸਾਰੇ ਸਹਾਏ ਮੋਡਿਊਲਾਂ ਲਈ ਸਿੱਧੀ ਨੈਵੀਗੇਸ਼ਨ।",
        ...
        bho: {
            lang: "भोजपुरी", log_out: "लॉग आउट", careers: "करियर", sign_in: "साइन इन", back: "होम पर वापस जाईं", sitemap: "प्लेटफॉर्म साइटमैप", sitemap_desc: "सब सहाय मॉड्यूल पर सीधा नेविगेशन।",
        ...
        ar: {
            lang: "العربية", log_out: "تسجيل الخروج", careers: "الوظائف", sign_in: "تسجيل الدخول", back: "العودة إلى الصفحة الرئيسية", sitemap: "خريطة الموقع", sitemap_desc: "التنقل المباشر لجميع وحدات ساهاي.",
        ...
        es: {
            lang: "Español", log_out: "Cerrar sesión", careers: "Carreras", sign_in: "Iniciar Sesión", back: "Volver a Inicio", sitemap: "Mapa del sitio", sitemap_desc: "Navegación directa a todos los módulos de Sahay.",
        ...
        fr: {
            lang: "Français", log_out: "Se déconnecter", careers: "Carrières", sign_in: "Se Connecter", back: "Retour à l'accueil", sitemap: "Plan du site", sitemap_desc: "Navigation directe vers tous les modules Sahay.",
        ...
        de: {
            lang: "Deutsch", log_out: "Abmelden", careers: "Karriere", sign_in: "Anmelden", back: "Zurück zur Startseite", sitemap: "Seitenverzeichnis", sitemap_desc: "Direkte Navigation zu allen Sahay-Modulen.",
