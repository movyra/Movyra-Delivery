...
export default function ComingSoon() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#000000] text-white font-sans selection:bg-white selection:text-black overflow-x-hidden flex flex-col relative">
      ...
      {/* GLOBAL LOGIN ROUTING & PORTAL NAVIGATION MODAL */}
      <AnimatePresence>
        {showLoginPrompt && (
          <motion.div 
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              {/* AUTHENTICATION FORM */}
              {!currentUser && (
                <div className="mb-8 border-b border-[#333333] pb-8">
                  {authError && (
              ...
              {/* GLOBAL PORTAL NAVIGATION MATRIX (VISIBLE POST-LOGIN) */}
              {currentUser && (
                <div className="flex flex-col gap-4 animate-fade">
                  <div className="bg-[#111111] p-4 rounded-xl text-center mb-2 border border-[#333333]">
                    <span className="text-[#00ff88] text-[0.8rem] font-bold uppercase tracking-widest block mb-1">Identity Verified</span>
                  ...
                  <Link to="/grocery" className="w-full bg-[#111111] border border-[#333333] p-4 rounded-2xl flex items-center justify-between group hover:border-white transition-colors">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[#888888] text-[0.75rem] font-medium mt-0.5">Consumer Grocery Portal</span>
                      </div>
                    </div>
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#666666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white transition-colors"><polyline points="9 18 15 12 9 6"></polyline></svg>
                  </Link>

                  <Link to="/veggies" className="w-full bg-[#111111] border border-[#333333] p-4 rounded-2xl flex items-center justify-between group hover:border-white transition-colors">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full border border-[#555555] flex items-center justify-center text-white group-hover:border-white transition-colors">
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
                      </div>
                      <div className="flex flex-col">
                        <span className="font-bold text-[1rem] text-white leading-tight">Veggies & Fruits</span>
                        <span className="text-[#888888] text-[0.75rem] font-medium mt-0.5">Fresh Produce Market</span>
                      </div>
                    </div>
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#666666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white transition-colors"><polyline points="9 18 15 12 9 6"></polyline></svg>
                  </Link>
