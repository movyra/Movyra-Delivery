...
function VendorOnboarding() {
  ...
  const t = {
    en: { title: "Partner Onboarding", subtitle: "Join the Movyra enterprise grid. List your business, restaurant, or fleet for seamless logistics integration.", bName: "Business / Entity Name", owner: "Contact Person Name", email: "Business Email", phone: "Phone Number", city: "Operating City", role: "Select Partner Category", roles: ["Restaurant / Cloud Kitchen", "FMCG Vendor", "Q-Commerce Partner", "Enterprise Fleet Owner", "Independent Courier"], vehicle: "Vehicle Class", vehicles: ["2-Wheeler (Bike/Scooter)", "3-Wheeler (EV/Auto)", "4-Wheeler (Mini Truck)", "Heavy Commercial"], submit: "Proceed to KYC", success: "Application Received", successSub: "We'll get back to you shortly.", back: "Return to Hub", kyc_face_title: "Live Verification", kyc_face_desc: "Please look directly at the camera. The system will auto-capture when a face is detected, or press the button to capture manually.", kyc_docs_title: "Compliance Documents", kyc_docs_desc: "Upload clear PDF or JPG copies of your official documents." },
    hi: { title: "पार्टनर ऑनबोर्डिंग", subtitle: "मूवीरा एंटरप्राइज ग्रिड से जुड़ें। अपने व्यवसाय या फ्लीट को सूचीबद्ध करें।", bName: "व्यवसाय का नाम", owner: "संपर्क व्यक्ति का नाम", email: "ईमेल", phone: "फ़ोन नंबर", city: "शहर", role: "श्रेणी चुनें", roles: ["रेस्टोरेंट / क्लाउड किचन", "FMCG वेंडर", "Q-कॉमर्स पार्टनर", "एंटरप्राइज फ्लीट मालिक", "स्वतंत्र कूरियर"], vehicle: "वाहन श्रेणी", vehicles: ["2-पहिया", "3-पहिया", "4-पहिया", "भारी वाणिज्यिक"], submit: "KYC के लिए आगे बढ़ें", success: "आवेदन प्राप्त हुआ", successSub: "हम जल्द ही आपसे संपर्क करेंगे।", back: "वापस जाएं", kyc_face_title: "चेहरा सत्यापन", kyc_face_desc: "अपनी पहचान सत्यापित करने के लिए कृपया सीधे कैमरे की ओर देखें। यदि स्वचालित रूप से कैप्चर नहीं होता है, तो बटन दबाएं।", kyc_docs_title: "व्यापार दस्तावेज़", kyc_docs_desc: "अपने आधिकारिक दस्तावेजों की स्पष्ट प्रतियां अपलोड करें।" },
    hinglish: { title: "Partner Onboarding", subtitle: "Movyra grid join karein. Apne business ya fleet ko list karein.", bName: "Business Name", owner: "Owner Name", email: "Business Email", phone: "Phone Number", city: "City", role: "Select Category", roles: ["Restaurant / Cloud Kitchen", "FMCG Vendor", "Q-Commerce Partner", "Enterprise Fleet Owner", "Independent Courier"], vehicle: "Vehicle Type", vehicles: ["2-Wheeler", "3-Wheeler", "4-Wheeler", "Heavy Truck"], submit: "KYC Shuru Karein", success: "Application Received", successSub: "Hum jaldi hi aapko contact karenge.", back: "Go Back", kyc_face_title: "Face Verification", kyc_face_desc: "Identity verify karne ke liye camera me dekhein. Agar auto-capture nahi hota, toh button dabayein.", kyc_docs_title: "Business Documents", kyc_docs_desc: "Official documents upload karein." },
    mr: { title: "भागीदार ऑनबोर्डिंग", subtitle: "Movyra ग्रिडमध्ये सामील व्हा. तुमचा व्यवसाय नोंदवा.", bName: "व्यवसायाचे नाव", owner: "मालकाचे नाव", email: "ईमेल", phone: "फोन नंबर", city: "शहर", role: "श्रेणी निवडा", roles: ["रेस्टॉरंट / क्लाउड किचन", "FMCG विक्रेता", "Q-कॉमर्स भागीदार", "एंटरप्राइझ फ्लीट मालक", "स्वतंत्र कुरिअर"], vehicle: "वाहन प्रकार", vehicles: ["दुचाकी", "तीन चाकी", "चार चाकी", "जड वाहन"], submit: "KYC सुरू करा", success: "अर्ज प्राप्त झाला", successSub: "आम्ही लवकरच आपल्याशी संपर्क साधू.", back: "मागे जा", kyc_face_title: "चेहरा पडताळणी", kyc_face_desc: "कॅमेराकडे पहा. स्वयंचलित न झाल्यास बटण दाबा.", kyc_docs_title: "कागदपत्रे", kyc_docs_desc: "कागदपत्रे अपलोड करा." },
    gu: { title: "ભાગીદાર ઑનબોર્ડિંગ", subtitle: "તમારો વ્યવસાય અથવા ફ્લીટ રજીસ્ટર કરો.", bName: "વ્યવસાયનું નામ", owner: "માલિકનું નામ", email: "ઈમેલ", phone: "ફોન નંબર", city: "શહેર", role: "શ્રેણી પસંદ કરો", roles: ["રેસ્ટોરન્ટ / ક્લાઉડ કિચન", "FMCG વિક્રેતા", "Q-કોમર્સ પાર્ટનર", "એન્ટરપ્રાઇઝ ફ્લીટ માલિક", "સ્વતંત્ર કુરિયર"], vehicle: "વાહન પ્રકાર", vehicles: ["2-વ્હીલર", "3-વ્હીલર", "4-વ્હીલર", "હેવી ટ્રક"], submit: "KYC શરૂ કરો", success: "અરજી મળી ગઈ", successSub: "અમે ટૂંક સમયમાં તમારો સંપર્ક કરીશું.", back: "પાછા જાઓ", kyc_face_title: "ચહેરો ચકાસણી", kyc_face_desc: "કેમેરા સામે જુઓ. જો ઑટો-કૅપ્ચર ન થાય તો બટન દબાવો.", kyc_docs_title: "દસ્તાવેજો", kyc_docs_desc: "દસ્તાવેજો અપલોડ કરો." },
    te: { title: "భాగస్వామి ఆన్‌బోర్డింగ్", subtitle: "Movyra ఎంటర్‌ప్రైజ్ గ్రిడ్‌లో చేరండి.", bName: "వ్యాపారం పేరు", owner: "యజమాని పేరు", email: "ఇమెయిల్", phone: "ఫోన్ నంబర్", city: "నగరం", role: "కేటగిరీ ఎంచుకోండి", roles: ["రెస్టారెంట్", "FMCG వెండర్", "Q-కామర్స్", "ఫ్లీట్ ఓనర్", "కొరియర్"], vehicle: "వాహనం రకం", vehicles: ["2-వీలర్", "3-వీలర్", "4-వీలర్", "హెవీ ટ્રక్"], submit: "KYC ప్రారంభించండి", success: "దరఖాస్తు స్వీకరించబడింది", successSub: "మేము త్వరలో మిమ్మల్ని సంప్రదిస్తాము.", back: "వెనక్కి వెళ్ళు", kyc_face_title: "ముఖ నిర్ధారణ", kyc_face_desc: "కెమెరాను చూడండి. ఆటో-క్యాప్చర్ విఫలమైతే బటన్‌ను నొక్కండి.", kyc_docs_title: "పత్రాలు", kyc_docs_desc: "పత్రాలను అప్‌లోడ్ చేయండి." },
    ta: { title: "கூட்டாளர் ஆன்போர்டிங்", subtitle: "உங்கள் வணிகம் அல்லது கடற்படையை பதிவு செய்யவும்.", bName: "வணிக பெயர்", owner: "உரிமையாளர் பெயர்", email: "மின்னஞ்சல்", phone: "தொலைபேசி எண்", city: "நகரம்", role: "வகையைத் தேர்ந்தெடுக்கவும்", roles: ["உணவகம்", "FMCG விற்பனையாளர்", "Q-காமர்ஸ்", "கடற்படை உரிமையாளர்", "கூரியர்"], vehicle: "வாகன வகை", vehicles: ["இரு சக்கர வாகனம்", "3 சக்கர வாகனம்", "4 சக்கர வாகனம்", "கனரக டிரக்"], submit: "KYC தொடங்கவும்", success: "விண்ணப்பம் பெறப்பட்டது", successSub: "நாங்கள் விரைவில் உங்களை தொடர்புகொள்வோம்.", back: "திரும்பி செல்", kyc_face_title: "முக சரிபார்ப்பு", kyc_face_desc: "காமிராவைப் பாருங்கள். தானாகப் படம் எடுக்கத் தவறினால் பட்டனை அழுத்தவும்.", kyc_docs_title: "ஆவணங்கள்", kyc_docs_desc: "ஆவணங்களை பதிவேற்றவும்." },
    pa: { title: "ਭਾਈਵਾਲ ਆਨਬੋਰਡਿੰਗ", subtitle: "ਆਪਣਾ ਕਾਰੋਬਾਰ ਜਾਂ ਫਲੀਟ ਰਜਿਸਟਰ ਕਰੋ।", bName: "ਕਾਰੋਬਾਰ ਦਾ ਨਾਮ", owner: "ਮਾਲਕ ਦਾ ਨਾਮ", email: "ਈਮੇਲ", phone: "ਫੋਨ ਨੰਬਰ", city: "ਸ਼ਹਿਰ", role: "ਸ਼੍ਰੇਣੀ ਚੁਣੋ", roles: ["ਰੈਸਟੋਰੈਂਟ", "FMCG ਵਿਕਰੇਤਾ", "Q-ਕਾਮਰਸ", "ਫਲੀਟ ਮਾਲਕ", "ਕੋਰੀਅਰ"], vehicle: "ਵਾਹਨ ਦੀ ਕਿਸਮ", vehicles: ["2-ਪਹੀਆ", "3-ਪਹੀਆ", "4-ਪਹੀਆ", "ਭਾਰੀ ਟਰੱਕ"], submit: "KYC ਸ਼ੁਰੂ ਕਰੋ", success: "ਬਿਨੈਪੱਤਰ ਪ੍ਰਾਪਤ ਹੋਇਆ", successSub: "ਅਸੀਂ ਜਲਦੀ ਹੀ ਤੁਹਾਡੇ ਨਾਲ ਸੰਪਰਕ ਕਰਾਂਗੇ।", back: "ਵਾਪਸ ਜਾਓ", kyc_face_title: "ਚਿਹਰੇ ਦੀ ਤਸਦੀਕ", kyc_face_desc: "ਕੈਮਰੇ ਵੱਲ ਦੇਖੋ। ਜੇਕਰ ਆਟੋ-ਕੈਪਚਰ ਫੇਲ ਹੁੰਦਾ ਹੈ ਤਾਂ ਬਟਨ ਦਬਾਓ।", kyc_docs_title: "ਦਸਤਾਵੇਜ਼", kyc_docs_desc: "ਦਸਤਾਵੇਜ਼ ਅੱਪਲੋਡ ਕਰੋ।" },
    ...
    ar: { title: "تسجيل الشركاء", subtitle: "انضم إلى شبكة Movyra. قم بإدراج عملك أو أسطولك.", bName: "اسم العمل", owner: "اسم المالك", email: "البريد الإلكتروني", phone: "رقم الهاتف", city: "المدينة", role: "اختر الفئة", roles: ["مطعم", "بائع FMCG", "شريك تجارة Q", "مالك أسطول", "ساعي مستقل"], vehicle: "فئة المركبة", vehicles: ["عجلتين", "ثلاث عجلات", "أربع عجلات", "شاحنة ثقيلة"], submit: "بدء KYC", success: "تم استلام الطلب", successSub: "سنعود إليك في وقت قصير.", back: "العودة", kyc_face_title: "التحقق من الوجه", kyc_face_desc: "انظر للكاميرا. اضغط على الزر إذا فشل الالتقاط التلقائي.", kyc_docs_title: "مستندات", kyc_docs_desc: "ارفع المستندات." },
    es: { title: "Registro de Socios", subtitle: "Únase a la red de Movyra. Registre su negocio o flota.", bName: "Nombre del Negocio", owner: "Nombre del Propietario", email: "Correo Electrónico", phone: "Número de Teléfono", city: "Ciudad", role: "Seleccionar Categoría", roles: ["Restaurante", "Vendedor FMCG", "Socio Q-Commerce", "Propietario de Flota", "Mensajero"], vehicle: "Clase de Vehículo", vehicles: ["2 Ruedas", "3 Ruedas", "4 Ruedas", "Camión Pesado"], submit: "Iniciar KYC", success: "Solicitud Recibida", successSub: "Nos pondremos en contacto con usted en breve.", back: "Volver", kyc_face_title: "Verificación facial", kyc_face_desc: "Mire a la cámara. Pulse el botón si la captura automática falla.", kyc_docs_title: "Documentos", kyc_docs_desc: "Subir documentos." },
    fr: { title: "Intégration des Partenaires", subtitle: "Rejoignez le réseau Movyra. Inscrivez votre entreprise.", bName: "Nom de l'Entreprise", owner: "Nom du Propriétaire", email: "E-mail", phone: "Numéro de Téléphone", city: "Ville", role: "Sélectionner la Catégorie", roles: ["Restaurant", "Vendeur FMCG", "Partenaire Q-Commerce", "Propriétaire de Flotte", "Coursier"], vehicle: "Type de Véhicule", vehicles: ["2 Roues", "3 Roues", "4 Roues", "Poids Lourd"], submit: "Démarrer KYC", success: "Demande Reçue", successSub: "Nous vous recontacterons sous peu.", back: "Retour", kyc_face_title: "Vérification faciale", kyc_face_desc: "Regardez la caméra. Appuyez sur le bouton si la capture automatique échoue.", kyc_docs_title: "Documents", kyc_docs_desc: "Télécharger les documents." },
    de: { title: "Partner-Onboarding", subtitle: "Treten Sie dem Movyra-Netzwerk bei. Registrieren Sie Ihr Unternehmen.", bName: "Firmenname", owner: "Name des Inhabers", email: "E-Mail", phone: "Telefonnummer", city: "Stadt", role: "Kategorie wählen", roles: ["Restaurant", "FMCG-Anbieter", "Q-Commerce-Partner", "Flottenbesitzer", "Kurier"], vehicle: "Fahrzeugklasse", vehicles: ["Zweirad", "Dreirad", "Vierrad", "Schwerer LKW"], submit: "KYC starten", success: "Bewerbung erhalten", successSub: "Wir werden uns in Kürze bei Ihnen melden.", back: "Zurück", kyc_face_title: "Gesichtsverifizierung", kyc_face_desc: "In die Kamera schauen. Drücken Sie die Taste, wenn die automatische Aufnahme fehlschlägt.", kyc_docs_title: "Dokumente", kyc_docs_desc: "Dokumente hochladen." }
  };
  ...
  const handleFinalSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Transmit logical reference schema to Centralized pre_registrations Firestore collection
        ...
        <div className="w-full bg-[#050505] border border-[#222] p-8 md:p-10 rounded-[24px] opacity-0 animate-fade stagger-2 shadow-[0_0_80px_rgba(255,255,255,0.03)]">
          {status === 'SUCCESS' ? (
            <div className="text-center py-10 flex flex-col items-center">
              ...
              <h3 className="font-black text-[1.8rem] mb-2">{cur.success}</h3>
              <p className="text-[#888888] text-[1.1rem] mb-10 font-bold">{cur.successSub}</p>
