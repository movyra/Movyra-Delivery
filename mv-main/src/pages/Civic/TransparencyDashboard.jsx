...
export default function TransparencyDashboard() {
    ...
    const t = {
        en: { lang: "English", help: "Help Center", back: "Back", log_out: "Log out", careers: "Careers", title: "Performance Data", sub: "Live data showing city efficiency, department work, and resolution rates.", total: "Total Reports", resolved: "Resolved", eff: "Efficiency Rate", workload: "Work Progress", concluded: "Finished", dpt: "Department Analysis", no_data: "Not enough data to show department metrics.", processing: "Loading live records...", acc: "Public Stats" },
