...
import { Search, Navigation, MapPin, ArrowDownUp, Plus, X } from 'lucide-react';
    ...
    <div className="w-full flex flex-col gap-3 font-sans relative">
      ...
      {dropoffs.length < 5 && (
        <motion.div 
          ...
          className="bg-white/50 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-[32px] p-4 flex items-center justify-center gap-3 cursor-pointer hover:bg-white hover:border-gray-400 transition-all text-gray-500 hover:text-black"
        >
