...
import { 
  ...
  CheckCircle2, AlertCircle, Loader2, XCircle, ChevronRight 
} from 'lucide-react';
...
// Modular UI Components (Corrected path for src/pages location)
 ...
 * Architecture: 32px deeply rounded cards on #F2F4F7 background.
 * Logic: Real-time Firestore sync with multi-state filtering.
 */
  ...
  return (
    <div className="min-h-screen bg-[#F2F4F7] text-[#111111] font-sans pb-32">
      ...
      <div className="px-6">
        ...
        {/* SECTION 2: Search & Tab Controllers */}
        <motion.div 
          initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          className="flex gap-3 mb-6"
        >
          <div className="flex-1 bg-white rounded-[20px] flex items-center px-4 py-3 border border-gray-100 focus-within:border-gray-300 transition-colors shadow-sm">
            ...
            <AnimatePresence mode='popLayout'>
              {filteredOrders.length > 0 ? (
                ...
                >
                  ...
                  <p className="text-[16px] font-black text-[#111111] mb-1">No Orders Found</p>
                  <p className="text-[13px] font-bold text-gray-400">Try switching tabs or adjusting your search.</p>
                </motion.div>
              )}
            </AnimatePresence>
          )}
